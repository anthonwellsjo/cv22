...
const BorderAnim: React.FC<props> = ({ children, zone, scroll, rotate, marginTop = "auto" }) => {
  ...
  const setNumberOfPlates = () => {
    ...
    switch (true) {
      ...
      case (divDimensionsRef.current.height < 1100 && divDimensionsRef.current.height >= 351 && divDimensionsRef.current.height > divDimensionsRef.current.width && divDimensionsRef.current.width < 500): sidePlates = divDimensionsRef.current.height / 37; break;
